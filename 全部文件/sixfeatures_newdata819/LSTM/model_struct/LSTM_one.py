...
class ConstructModel(object):
    ...
    def first(self):
        ...
        attention_mul = Dense(128, kernel_regularizer=l1_l2(l1_l2_rate, l1_l2_rate),
                              bias_regularizer=l1_l2(l1_l2_rate, l1_l2_rate))(attention_mul)
        attention_mul = BatchNormalization()(attention_mul)
        attention_mul = Dropout(DROPOUT_RATE)(attention_mul)
...
if __name__ == '__main__':
    ...
    for x in range(0, 10):
        ...
        for i in range(3, 9):
            ...
            num1 = i
            # print(num1)
            x_train, y_train = data_process(train_df, [num1])
            x_valid, y_valid = data_process(valid_df, [num1])
            x_test, y_test = data_process(test_df, [num1])
            # print(x_train)
            # print(x_valid)
            # print(y_valid)
            # print(x_test)
            ...
            best_model = "../save_model/model_oneclass" + str(
                x) + ".h5"
